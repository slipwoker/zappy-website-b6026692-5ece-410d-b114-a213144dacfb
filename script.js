    ...
    function handleFormSubmit(e) {
        ...
        if (isValid) {
            ...
            setTimeout(() => {
                ...
                successMsg.style.cssText = 'color: #38a169; padding: 1rem; text-align: center; font-weight: 600;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b6026692-5ece-410d-b114-a213144dacfb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b6026692-5ece-410d-b114-a213144dacfb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b6026692-5ece-410d-b114-a213144dacfb';
